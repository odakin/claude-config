...
## <a id="start-fresh"></a>1. Start every session fresh
...
## <a id="pre-push-incantation"></a>2. The pre-push incantation
...
## <a id="think-deeply"></a>3. Say "think deeply" for non-trivial decisions
...
## <a id="competitive-analysis"></a>5. Use competitive analysis for feature planning
...
## <a id="invest-in-conventions"></a>6. Invest feedback in conventions and hooks, not memory
...
## <a id="single-sot-no-cycles"></a>7. Single source of truth, no circular references
...
## <a id="claudemd-chain"></a>8. Mind the CLAUDE.md chain in sub-projects
...
## <a id="doc-role-separation"></a>9. Project doc role separation: "don't write the same insight five times"
