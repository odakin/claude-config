...
> ドメイン固有規約は `conventions/` に分離 (**全列挙** = `conventions/*.md` の全 file・名前順、 カテゴリ別 index = [conventions/README.md](conventions/README.md)。 本列挙・CLAUDE.md 構造 tree・README は `scripts/generate-tree.py` が各 file 冒頭の doc-meta frontmatter から自動生成 — 新規 file は doc-meta を書いて `--write` を回せば全生成物へ同時反映、 drift は CI / pre-commit の `--check` が検出。 `.ja.md` 翻訳 variant は親 entry に併記): [academic-program-verification.md](conventions/academic-program-verification.md), [actor-attribution.md](conventions/actor-attribution.md), [agent-rule-ownership.md](conventions/agent-rule-ownership.md), [android-chromium-remote-debug.md](conventions/android-chromium-remote-debug.md), [ask-user-question.md](conventions/ask-user-question.md), [audio-transcription.md](conventions/audio-transcription.md), [batch-text-edits.md](conventions/batch-text-edits.md), [beamer-slides.md](conventions/beamer-slides.md), [book-purchase-lookup.md](conventions/book-purchase-lookup.md), [campussquare.md](conventions/campussquare.md), [chalkboard-close-up-merge.md](conventions/chalkboard-close-up-merge.md), [chalkboard-photo-archive.md](conventions/chalkboard-photo-archive.md), [claude-ai-routines.md](conventions/claude-ai-routines.md), [claude-app-bundle-reading.md](conventions/claude-app-bundle-reading.md), [claude-app-cwd-pin.md](conventions/claude-app-cwd-pin.md), [claude-code-permissions.md](conventions/claude-code-permissions.md), [clipboard-cleaner.md](conventions/clipboard-cleaner.md), [cold-eyes-isolation.md](conventions/cold-eyes-isolation.md), [collaborators.md](conventions/collaborators.md), [concise-output.md](conventions/concise-output.md), [confidential-repo-boundary.md](conventions/confidential-repo-boundary.md), [consumer-review-posting.md](conventions/consumer-review-posting.md), [data-pipeline-automation.md](conventions/data-pipeline-automation.md), [debugging-discipline.md](conventions/debugging-discipline.md), [discord-bot.md](conventions/discord-bot.md), [dropbox-api-access.md](conventions/dropbox-api-access.md), [dropbox-placeholder-diagnosis.md](conventions/dropbox-placeholder-diagnosis.md), [dropbox-refs.md](conventions/dropbox-refs.md), [email-surface-pattern.md](conventions/email-surface-pattern.md), [erad-submission.md](conventions/erad-submission.md), [expensive-intermediate-artifacts.md](conventions/expensive-intermediate-artifacts.md), [flight-search.md](conventions/flight-search.md), [form-case-pipeline.md](conventions/form-case-pipeline.md), [garoon.md](conventions/garoon.md), [github-security-automation.md](conventions/github-security-automation.md), [giving-talks.md](conventions/giving-talks.md) (+ [ja](conventions/giving-talks.ja.md)), [gmail-mcp-multiaccount.md](conventions/gmail-mcp-multiaccount.md), [gmail-sending.md](conventions/gmail-sending.md), [google-api-direct-access.md](conventions/google-api-direct-access.md), [google-classroom-api.md](conventions/google-classroom-api.md), [google-forms-automation.md](conventions/google-forms-automation.md), [google-url.md](conventions/google-url.md), [hanko-digitization.md](conventions/hanko-digitization.md), [hook-authoring.md](conventions/hook-authoring.md), [identity-in-config.md](conventions/identity-in-config.md), [indico-abstract-submission.md](conventions/indico-abstract-submission.md), [inline-svg-illustration.md](conventions/inline-svg-illustration.md), [install-failures.md](conventions/install-failures.md), [japanese-email-honorifics.md](conventions/japanese-email-honorifics.md), [jma-obsdl-download.md](conventions/jma-obsdl-download.md), [jps-talk-submission.md](conventions/jps-talk-submission.md), [kakenhi-proposal.md](conventions/kakenhi-proposal.md), [latex.md](conventions/latex.md), [launchd-cloudstorage-tcc.md](conventions/launchd-cloudstorage-tcc.md), [machine-route-first.md](conventions/machine-route-first.md), [macos-app-crash-triage.md](conventions/macos-app-crash-triage.md), [macos-calendar-write.md](conventions/macos-calendar-write.md), [macos-claude-app-notifications.md](conventions/macos-claude-app-notifications.md), [macos-claude-app-pty-leak.md](conventions/macos-claude-app-pty-leak.md), [macos-claude-code-tcc-recurring-prompt.md](conventions/macos-claude-code-tcc-recurring-prompt.md), [macos-clickable-notifications.md](conventions/macos-clickable-notifications.md), [macos-exec-policy-kill.md](conventions/macos-exec-policy-kill.md), [macos-filevault.md](conventions/macos-filevault.md), [macos-gui-app-automation.md](conventions/macos-gui-app-automation.md), [macos-hdmi-external-display.md](conventions/macos-hdmi-external-display.md), [macos-ime-ascii-layout.md](conventions/macos-ime-ascii-layout.md), [macos-notification-db.md](conventions/macos-notification-db.md), [macos-post-update-slowdown.md](conventions/macos-post-update-slowdown.md), [macos-side-by-side-app-migration.md](conventions/macos-side-by-side-app-migration.md), [macos-tahoe-wallpaper.md](conventions/macos-tahoe-wallpaper.md), [mail-thread-ledger.md](conventions/mail-thread-ledger.md), [manuscript-claim-ownership.md](conventions/manuscript-claim-ownership.md), [matplotlib-3d-illustrations.md](conventions/matplotlib-3d-illustrations.md), [matplotlib-figure-qa.md](conventions/matplotlib-figure-qa.md), [mcp.md](conventions/mcp.md), [media-transcription-ledger.md](conventions/media-transcription-ledger.md), [memory-file-slimming.md](conventions/memory-file-slimming.md), [mid-turn-text-visibility.md](conventions/mid-turn-text-visibility.md), [ml-forward-judgment.md](conventions/ml-forward-judgment.md), [multi-account-machine-surface.md](conventions/multi-account-machine-surface.md), [multi-machine-state.md](conventions/multi-machine-state.md), [multi-session-coordination.md](conventions/multi-session-coordination.md), [name-rendering.md](conventions/name-rendering.md), [office-automation-principles.md](conventions/office-automation-principles.md), [office-automation.md](conventions/office-automation.md), [office-files.md](conventions/office-files.md), [output-cap-death-loop.md](conventions/output-cap-death-loop.md), [overleaf-integration.md](conventions/overleaf-integration.md), [paper-audit.md](conventions/paper-audit.md), [paper-submission.md](conventions/paper-submission.md), [paste-destined-plain-text.md](conventions/paste-destined-plain-text.md), [peer-review-workflow.md](conventions/peer-review-workflow.md), [personal-skills.md](conventions/personal-skills.md), [photographed-document-transcription.md](conventions/photographed-document-transcription.md), [physics-notes.md](conventions/physics-notes.md), [physics-verification-cycle.md](conventions/physics-verification-cycle.md), [podcast-audio-finishing.md](conventions/podcast-audio-finishing.md), [podcast-distribution.md](conventions/podcast-distribution.md), [preview.md](conventions/preview.md), [prompt-injection.md](conventions/prompt-injection.md), [pronunciation-verification.md](conventions/pronunciation-verification.md), [prototype-feedback.md](conventions/prototype-feedback.md), [public-page-watch.md](conventions/public-page-watch.md), [rebuttal-letter.md](conventions/rebuttal-letter.md), [remote-control-server.md](conventions/remote-control-server.md), [repo-history-growth.md](conventions/repo-history-growth.md), [research-email.md](conventions/research-email.md), [researchmap.md](conventions/researchmap.md), [scanned-book-survey.md](conventions/scanned-book-survey.md), [scheduled-tasks.md](conventions/scheduled-tasks.md), [scientific-computing.md](conventions/scientific-computing.md), [script-layer-placement.md](conventions/script-layer-placement.md), [secret-handoff.md](conventions/secret-handoff.md), [semgrep-ci.md](conventions/semgrep-ci.md), [sensitive-data-pass-through.md](conventions/sensitive-data-pass-through.md), [shared-repo.md](conventions/shared-repo.md), [shell-env.md](conventions/shell-env.md), [shell-multibyte-truncation.md](conventions/shell-multibyte-truncation.md), [slack-mcp.md](conventions/slack-mcp.md), [static-site-form-backend.md](conventions/static-site-form-backend.md), [substack.md](conventions/substack.md), [tenki-submission.md](conventions/tenki-submission.md), [tikz-pgfplots.md](conventions/tikz-pgfplots.md), [time-context.md](conventions/time-context.md), [tool-call-malformed-paste.md](conventions/tool-call-malformed-paste.md), [tool-call-robustness.md](conventions/tool-call-robustness.md), [tts-review.md](conventions/tts-review.md), [ui-toggle-convention.md](conventions/ui-toggle-convention.md), [verification-cycle-ops.md](conventions/verification-cycle-ops.md), [web-form-automation.md](conventions/web-form-automation.md), [web-map-projections.md](conventions/web-map-projections.md), [web-tools.md](conventions/web-tools.md), [windows-msys.md](conventions/windows-msys.md), [wolfram-scripting.md](conventions/wolfram-scripting.md), [yaml-hazards.md](conventions/yaml-hazards.md), [zenn.md](conventions/zenn.md), [zoom-meetings.md](conventions/zoom-meetings.md)
> <!-- AUTO-ENUM END -->
>
...
pointer は bare link でなく「いつ、どの file を読むか」を命じる imperative な
dispatcher として書く。Codex は link 先を instruction chain へ自動展開しないため、
...
新規 shared repo は [`templates/shared-project/AGENTS.md.template`](templates/shared-project/AGENTS.md.template) から作る。既存 repo にも同じ雛形を機械で置く (= 「次に触る時に足す」 を人の記憶に任せると足されない、 [#manual-work-in-design-records](docs/convention-design-principles.md#manual-work-in-design-records))。 root に `CLAUDE.md` があって `AGENTS.md` が無い repo では、 commit のたびに pre-commit が知らせる (止めない、 [`scripts/lib/agents-entrypoint-warn.sh`](scripts/lib/agents-entrypoint-warn.sh))。 中身は `scripts/audit-codex-integration.sh --repo <path>` で root 配置・tracking・上記 pointer・4 KiB 上限を検査する。installer が layer 2 project file を勝手に生成してはならない。`project_doc_fallback_filenames` 等の個人設定は layer 4 の補助にすぎず、共同編集者・別ホストで解決できる committed `AGENTS.md` の代替にしない。
...
| 再利用可能な script の判定・変換・selftest | [`script-layer-placement.md`](conventions/script-layer-placement.md) に従い上層 engine。owner / project 固有値は下層 config・shim |
...
| pattern | 例 | fix |
|---|---|---|
| **archive 移動 path drift** | ref = `<repo>/SESSION.md §<節名>` だが section は `SESSION-archive/2026-05-pre-20.md` に移動済 | path を archive に update + 「YYYY-MM-DD archive split で移動済」 marker を inline 付加 |
...
9. **規則・必須手順・検査の適用や変更を判断する前に**: [agent-rule-ownership.md#rule](conventions/agent-rule-ownership.md#rule) を読む。作業分野と vendor を問わない。
10. **原稿の主張・式の変更を行う前に**: [manuscript-claim-ownership.md#rule](conventions/manuscript-claim-ownership.md#rule) の著者の裁定と編集範囲を確認する。
