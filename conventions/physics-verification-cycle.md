...
| <a id="referee-side-kernels"></a>`#referee-side-kernels` — 17. 盲検 reviewer 側の道具と kernel (移設後に新設 2026-09; 転送のみ) | [`physics-verification-cycle.md#referee-side-kernels`](../../ai-collaboration/conventions/physics-verification-cycle.md#referee-side-kernels) |
| <a id="unbounded-moment-domain-audit"></a>`#unbounded-moment-domain-audit` — 18. 非有界な moment operator と有限観測窓の audit kernel (移設後に新設 2026-09; 転送のみ) | [`physics-verification-cycle.md#unbounded-moment-domain-audit`](../../ai-collaboration/conventions/physics-verification-cycle.md#unbounded-moment-domain-audit) |
| <a id="action-equivalence-and-polynomiality"></a>`#action-equivalence-and-polynomiality` — 20. 作用の等価性・多項式性を検証する kernel (移設後に新設 2026-09; 転送のみ) | [`physics-verification-cycle.md#action-equivalence-and-polynomiality`](../../ai-collaboration/conventions/physics-verification-cycle.md#action-equivalence-and-polynomiality) |
