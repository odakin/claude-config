...
| <a id="continuous-rank-one-povm-rn-route"></a>`#continuous-rank-one-povm-rn-route` — 第 3 経路 (RN 二表示、 移設後に新設 2026-09-06; 転送のみ) | [`physics-verification-cycle.md#continuous-rank-one-povm-rn-route`](../../ai-collaboration/conventions/physics-verification-cycle.md#continuous-rank-one-povm-rn-route) |
