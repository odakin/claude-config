...
- **分野責任者 ≠ 実際の担当者・実作業者**: 元メール TO は「分野代表 5 名」 で、 ML forward はその後ろにいる「実作業者全員」 への展開。 実際の作業者は ML メンバー (= 数十人) から自分の分野の担当者として割り当てられている
...
2. **元メール本文に「分野」 「担当」 「責任者」 「実作業」 「審査」 等の役割割当キーワードがあるか?**
...
3. **過去の関連 ML スレッドで自分の名前が割当 source として出ているか?**
   ...
   - 該当スレッドの本文を読み、 「分野 / 担当 / 実作業者」 として自分の名前を grep
