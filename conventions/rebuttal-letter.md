...
## <a id="deferred-check-reserve"></a>「検証済みだが companion 送り」 の cross-check は、 構造的境界で閉じる部分を本稿に印字し、 残りを response letter の予備として持つ (2026-09-08、 2026-09-09 改訂)
