...
強める変更か弱める変更かは機械で決められない (追記 1 文でも「ただし急ぐ時は不要」 で緩む)。 そこで意味ではなく変更の形で線を引き、 事前に止めない代わりに、 入れた turn の返事で本人の目に入れる。 本人が採った 3 点:
...
- 緩和の語を使わない追記は通る: 一覧に無い言い回しでの範囲の限定・定義の差し替え・歴史化・優先順位、 語を避けて書いた後の節の矛盾する規則 (一覧には独立の検品で見つかった型を足してあるが、 言い換えは尽くせない)。 新しい `conventions/*.md` と、 それを指す 1 行を別々に足す組み合わせも、 それぞれ追記として通る。 どれも事前には止まらず、 入れた turn の返事で本人の目に入る。
