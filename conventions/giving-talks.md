...
- **A message is an assertion, not a topic; and background is not a message.** Write each
  message as a sentence with a verb — the claim the audience should take home ("the vierbein's
  kinetic term is generated by the loop, with both gauge symmetries intact") — and use its short
  form as the title. A noun-phrase title ("the induced action and its five coefficients") can
