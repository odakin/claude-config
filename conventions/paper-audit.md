...
[`#relocation-rebinding-sweep`](#relocation-rebinding-sweep) は文脈手術で**束縛が壊れる**ときの sweep。こちらは**新しく書いた文**で、係り先・射程が最初から一意でない形。著者の通読 pass (1 日 40 pass) で「何を指してるか分からない」「曖昧」と止まった箇所は、ほぼ全部が次の 7 形のどれかだった。
